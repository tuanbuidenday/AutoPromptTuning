...
Vài thuật ngữ sẽ gặp suốt tài liệu:

| Thuật ngữ | Nghĩa |
|---|---|
| **sample** | Một dòng dữ liệu: một đoạn văn bản kèm đáp án đúng của nó |
| **flip** | Sample mà prompt cũ trả lời sai còn prompt mới trả lời đúng |
| **ceiling score** | Điểm kịch khung, tức 100/100 — không thể cao hơn |
| **shortcut rule** | Mẹo đoán tắt, kiểu "thấy chữ URGENT thì trả lời Yes" |
...
| **discordant pair** | Sample mà hai prompt trả lời khác nhau — chỉ những sample này mới phân biệt được hai prompt |
...
200). Chi tiết ở [RESULTS.md](RESULTS.md). Lõi framework không sửa dòng nào.
...
## 5. Sao biết prompt không phải học thuộc dataset?
...
## 6. Dataset có dễ quá không? Model đoán mò cũng đúng chăng?
...
Dataset đầu tiên mình làm hỏng đúng chỗ này: 15/15 ticket gào to đều là No. Model
...
"nhạy cảm" nên dataset phải rải chữ đó đều 50/50, nếu không thì ta đang đo từ khoá
...
Muốn siết non-inferiority xuống margin 3 điểm thì cần hơn 400 sample test. Bộ hiện
