...
### Optimizer `llm_rewrite` (mặc định, có sẵn)
...
### Optimizer `autoprompt` (plugin — engine ngoài cắm vào)

Đây là bằng chứng cho luận điểm trung tâm: một engine có sẵn ngoài đời cắm vào
framework qua đúng interface `BaseOptimizer`, không sửa một dòng nào trong lõi.
Chạy thật với Gemini, train 60 / test 200:

| | Train (60) | **Test (200)** |
|---|---|---|
| Prompt gốc | 70.0 | — |
| Prompt tối ưu | 86.7 | **85.0** — CI 95% [79.4, 89.3] |
